...
/// Changes the owner of a chat; requires owner privileges in the chat. Use
/// the method canTransferOwnership to check whether the ownership can be
/// transferred from the current session. Available only for supergroups and
/// channel chats
/// Returns [Ok]
@immutable
