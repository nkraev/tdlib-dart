...
/// messages of the types messagePinMessage, messageGameScore,
/// messagePaymentSuccessful, messageChatSetBackground,
/// messageGiveawayCompleted, messageChecklistTasksDone and
/// messageChecklistTasksAdded, and topic messages without non-bundled replied
/// message respectively. Returns a 404 error if the message doesn't exist
/// Returns [Message]
@immutable
class GetRepliedMessage extends TdFunction {
  const GetRepliedMessage({required this.chatId, required this.messageId});
