...
class FormattedText extends TdObject {
  ...
  /// entities can't contain other entities. BlockQuote entities can't contain
  /// other BlockQuote entities. Bold, Italic, Underline, Strikethrough, and
  /// Spoiler entities can contain and can be part of any other entities. All
  /// other entities can't contain each other
